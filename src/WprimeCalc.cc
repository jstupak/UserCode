...
public:
	...
	if (mPset.exists("sampleWeight")) mdSampleWeight=mPset.getParameter<double>("sampleWeight");
	else mdSampleWeight=1;
...
int WprimeCalc::AnalyzeEvent(edm::EventBase const & event,
    ...
    SetValue("sampleWeight",mdSampleWeight);
