...
chargedHiggs200=Sample('chargedHiggs200',sampleType='signal',altName='H^{#pm} (m=200 GeV)',crossSection=1.485*1.317e-1,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-200_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs300=Sample('chargedHiggs300',sampleType='signal',altName='H^{#pm} (m=300 GeV)',crossSection=1.556*9.016e-2,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-300_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs400=Sample('chargedHiggs400',sampleType='signal',altName='H^{#pm} (m=400 GeV)',crossSection=1.631*3.848e-2,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-400_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs500=Sample('chargedHiggs500',sampleType='signal',altName='H^{#pm} (m=500 GeV)',crossSection=1.695*1.713e-2,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-500_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs600=Sample('chargedHiggs600',sampleType='signal',altName='H^{#pm} (m=600 GeV)',crossSection=1.74*8.066e-3,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-600_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs700=Sample('chargedHiggs700',sampleType='signal',altName='H^{#pm} (m=700 GeV)',crossSection=1.788*4.004e-3,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-700_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
chargedHiggs800=Sample('chargedHiggs800',sampleType='signal',altName='H^{#pm} (m=800 GeV)',crossSection=1.828*2.071e-3,filesPerJob=10,nEvents=900000,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-800_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')

signal=[chargedHiggs200,chargedHiggs300,chargedHiggs400,chargedHiggs500,chargedHiggs600,chargedHiggs700,chargedHiggs800]
