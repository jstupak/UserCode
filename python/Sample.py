...
chargedHiggs400=Sample('chargedHiggs400',sampleType='signal',altName='H^{#pm} (m=400 GeV)',crossSection=1.631*3.848e-2,filesPerJob=10,nEvents=,inputListFile='src/LJMet/Com/python/Samples_2012/ChargedHToTB_M-400_tanBeta30_8TeV_pythia6_tauola_Summer12_DR53X_PU_S10_START53_V7C_v1_TLBSM_53x_v2.txt')
